 ...
 * @author giov
 */
public class PesquisarProd extends javax.swing.JDialog {

    private List<Produto> lista = new ArrayList<>();

    private Produto prodSelecionado;

    private ProdutoControleDAO daoProd = new ProdutoControleDAO();

    private boolean selecionado = false;

    public PesquisarProd(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void atualizaTabela() {
        ...
        this.lista.clear();
        this.lista.addAll(daoProd.getPorTipo(txtProcura.getText()));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtProcura, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        ...
        if (linha == -1) {
            ...
            this.prodSelecionado = lista.get(linha);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisarProd dialog = new PesquisarProd(new javax.swing.JFrame(), true);
